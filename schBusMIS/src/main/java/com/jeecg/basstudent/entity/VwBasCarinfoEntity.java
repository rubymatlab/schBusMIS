 ...
 */
@Entity
@Table(name = "vw_bas_carinfo", schema = "")
@SuppressWarnings("serial")
public class VwBasCarinfoEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="BS_CARDNO",nullable=true,length=36)
	...
	@Column(name ="BS_IMEI",nullable=true,length=36)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  绑定学生姓名
	 */

	@Column(name ="BS_NAME",nullable=true,length=36)
	...
	@Column(name ="BS_DEVICEID",nullable=true,length=36)
