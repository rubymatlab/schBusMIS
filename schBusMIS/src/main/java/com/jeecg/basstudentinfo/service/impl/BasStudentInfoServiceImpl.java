...
@Service("basStudentInfoService")
@Transactional
public class BasStudentInfoServiceImpl extends CommonServiceImpl implements BasStudentInfoServiceI {
	 ...
	 */
	 public JSONObject doAddDeviceBus(BasStudentInfoEntity t) throws Exception{
	 	...
	 	//-----------------java增强 start---------------------------
	 		...
	 		JSONObject json=executeJavaExtend("spring","AddDevice",data);
	 		return json;
	 	//-----------------java增强 end-----------------------------
	 }
 	/**
	 ...
	 */
	 public JSONObject doDeleteDeviceBus(BasStudentInfoEntity t) throws Exception{
	 	...
	 	//-----------------java增强 start---------------------------
	 		Map<String,Object> data = populationMap(t);
	 		JSONObject json=executeJavaExtend("spring","DeleteDevice",data);
	 		return json;
	 	//-----------------java增强 end-----------------------------
	 }
	 ...
	 * @return
	 */
	private void doAddBus(BasStudentInfoEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(BasStudentInfoEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(BasStudentInfoEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(BasStudentInfoEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,BasStudentInfoEntity t){
	 ...
	 */
 	...
 	private void executeSqlEnhance(String sqlEnhance,BasStudentInfoEntity t){
	 	Map<String,Object> data = populationMap(t);
