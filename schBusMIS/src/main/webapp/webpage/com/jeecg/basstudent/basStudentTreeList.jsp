...
<div class="easyui-layout" fit="true">
	<div data-options="region:'west',title:'组织管理',split:true"
...
function loadTree() {
	...
	jQuery.ajax({  
        ...
        type: 'POST',  
        dataType : "json",  
        url: 'basStudentTreeController.do?getTreeBusLineData',//请求的action路径  
	...
	var ztreeCreator = new ZtreeCreator('orgTree',"basStudentTreeController.do?getTreeBusLineData",zNodes)
...
function zTreeOnLeftClick(event, treeId, treeNode) {
	...
	var url="cgAutoListController.do?list&id=bas_student&searchColums=&searchColumsForm=&undefined=&bs_name=&bc_name=&bl_size="+curSelectNode.name+"&page=1&rows=10&sort=create_date&order=desc";
