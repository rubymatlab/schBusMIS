    ...
    var postUrl = "http://devzhu.hk1.mofasuidao.cn/schBusMIS/baswxcontroller.do?getStudent";//请求路径
...
function getUrl() {
	...
	if (window.confirm('确定解绑？ 如解绑则查阅不到个人的相关信息!')) {
	    var postUrl = "http://devzhu.hk1.mofasuidao.cn/schBusMIS/baswxcontroller.do?unBinding";//请求路径
